...
#df = pd.read_excel(direccion_base1,sheet_name="Canales_PO")
#nombre_excel = "Libro1.xlsx"
#processor =CalculoCanalesPostres(df,nombre_excel, "Canales_PO")
#processor.procesar()