...
class DatosDemograficos:
    ...
    def _escribir_en_excel(self, dataframes):
        ...
        # Aquí irían las funciones para aplicar formatos
    ...
    def procesar(self):
        diccionario_datos = self._obtener_dataframes_por_titulo_y_region(self.df)
...
#df = pd.read_excel(direccion_base1,sheet_name="Demo_yog")
#nombre_excel = "Libro1.xlsx"
#processor =DatosDemograficosProcessor(df,nombre_excel, "Demo_yog")
#processor.procesar()